...
function gotResults(error, results) {
    if (error){
        ...
        img = document.getElementById('2022-03-08(2).png');
        img1 = document.getElementById('ear.jpg');
        img2 = document.getElementById('2022-03-08(3),.png');

        if (results[0].label == "bark") {
            img.src = 'bark.gif';
            img1.src = '2022-03-08(3).png';
        } else if (results[0].label == "meow") {
            img.src = '2022-03-08(2).png';
            img1.src = 'meow.gif';
        }
    }
}